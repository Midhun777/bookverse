...
const { getAllUsers, banUser, deleteUser, updateSettings, getAppStats, getSettings, getAllReviews, resolveReview } = require('../controllers/adminController');
...
router.put('/reviews/resolve/:reviewId', protect, authorize('ADMIN'), resolveReview);
